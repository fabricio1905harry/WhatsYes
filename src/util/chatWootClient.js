...
export default class chatWootClient {
  constructor(config, session) {
    this.config = config;
    this.mobile_name = this.config.mobile_name ? this.config.mobile_name : `WhatsYes`;
    this.mobile_number = this.config.mobile_number ? this.config.mobile_number : '5511958493514';
    this.sender = {
